...
<head>
	...
	<script>
		/* 
			...
			for(요소 of 배열객체명){//자바의 확장 for문과 비슷
				실행코드 : 요소
			}
		*/
		const subList = ['java', 'oracle', 'html', 'css'];
		...
		for(subject of subList){ //subList의 요소인 변수 subject를 넣음 
			document.write('subList = ' +subject + "<br>");
		}
		
		//4. for each => arrow
		document.write( "<h3> 4. forEach </h3>");
		subList.forEach((value, index, array) => { //값, 인덱스 ,배열
